                    ...
                    switch(objArg.sep){
                        ...
                        case '^^':
                            ...
                            case '%%':
                                ...
                                if (objArg.define.indexed && objArg.define.indexed === true) {
    
                                    if (!objArg.define.indexingCustomFunction) {
    
                                        objArg.define.indexingCustomFunction ='jsonb_pretty';
    
                                    }
    
                                    strArg = objArg.define.indexingCustomFunction + "(" + objArg.name + ")" + " ILIKE ('%" + objArgValue + "%') ";
    
                                    if (objArg.keyName) {
    
                                        if(objArg.define.indexedKeys.includes(objArg.keyName)) {
    
                                            if(objArg.keyName.includes(',')) {
    
                                                let keyName = objArg.keyName.replace(",","'->'");
                                                strArg = objArg.define.indexingCustomFunction + "(" + objArg.name + " -> " + "'" + keyName + "'" + ")" + " ILIKE ('%" + objArgValue + "%') ";
                                                break;
    
                                            }
    
                                            strArg = objArg.define.indexingCustomFunction + "(" + objArg.name + " -> '" + objArg.keyName + "' )" + " ILIKE ('%" + objArgValue + "%') ";
